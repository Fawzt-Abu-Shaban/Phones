                    ...
                    <div class="card card-primary">
                        ...
                        <form method="POST" id="reset_form">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="guard" class="form-control guard" style="width: 100%;">
                                        <option value="{{ $permission->guard_name }}" selected>{{ $permission->guard_name }}
                                        </option>
                            ...
                            <div class="card-footer">
                                <button type="button" onclick="updateItem({{ $permission->id }})"
...
@section('script')
    ...
    <script>
        ...
        function updateItem(id) {
            ...
            update('/mobile/admin/permission', id, data, '/mobile/admin/permission')
        }
    </script>
